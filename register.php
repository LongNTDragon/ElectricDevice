...
<?php require "./menu.php"?>
    ...
    <div class="row container-fluid" style="margin-top: 5rem;">
        ...
        <div class="col-md-6 col-sm-10 mt-4 card">
          <div class="card-body">
            <h2 class="text-center text-white">ĐĂNG KÝ TÀI KHOẢN</h2>
            ...
            <form action="register.php" method="post">                
                ...
                <div class="row w-75 mx-auto mt-3 mb-3">
                    ...
                    <div class="col-md-4"><input type="submit" id="submit" name="submit" class="form-control" value="ĐĂNG KÝ" style="width: 100%; margin-top: 0.5rem;" /></div>
                </div>
            </form>
          </div>
        </div>
